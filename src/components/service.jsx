    ...
    <>
      ...
      >
        ...
        >
          ...
          ></Avatar>
          <Typography variant="h6" sx={{padding: ".5rem 1rem",fontWeight:"bolder"}}>Stell Erection</Typography>
          <Typography variant="p" sx={{padding: ".0rem 1rem"}}>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident
            quidem placeat quam voluptatum reprehenderit reiciendis quae
            distinctio. Fugit cum, nostrum maiores voluptas distinctio incidunt
            sed, sint impedit, officiis nisi minus!
          </Typography>
        </Box>
        <Box
          sx={{
        ...
        >
          ...
          ></Avatar>
          <Typography variant="h6" sx={{padding: ".5rem 1rem",fontWeight:"bolder"}}>Standing Seam</Typography>
          <Typography variant="p" sx={{padding: ".0rem 1rem"}}>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident
            quidem placeat quam voluptatum reprehenderit reiciendis quae
            distinctio. Fugit cum, nostrum maiores voluptas distinctio incidunt
